...
- Plan tests for new functionality. Tests catch regressions across cycles and help verification. If the project doesn't have a test runner yet and the project would benefit from one, plan a step to set one up early in the cycle.
